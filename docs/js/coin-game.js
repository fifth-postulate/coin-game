...
var _fifth_postulate$coin_game$Game_Model$other = function (player) {
	var _p0 = player;
	if (_p0.ctor === 'PlayerA') {
		return _fifth_postulate$coin_game$Game_Model$PlayerB;
	} else {
...
var _fifth_postulate$coin_game$Helper$replace = F3(
	function (list, index, element) {
		return ((_elm_lang$core$Native_Utils.cmp(0, index) < 1) && (_elm_lang$core$Native_Utils.cmp(
			index,
			_elm_lang$core$List$length(list)) < 0)) ? _elm_lang$core$Maybe$Just(
			A2(
				...
				A2(
					...
					A2(_elm_lang$core$List$drop, index + 1, list)))) : _elm_lang$core$Maybe$Nothing;
	});
var _fifth_postulate$coin_game$Helper_ops = _fifth_postulate$coin_game$Helper_ops || {};
_fifth_postulate$coin_game$Helper_ops['@'] = F2(
	function (list, index) {
		if (_elm_lang$core$Native_Utils.cmp(index, 0) < 1) {
			...
			if (_p0.ctor === 'Just') {
				return A2(
					F2(
						function (x, y) {
							return A2(_fifth_postulate$coin_game$Helper_ops['@'], x, y);
						}),
					_p0._0,
					index - 1);
			} else {
...
var _fifth_postulate$coin_game$Game_Update$Play = F2(
	function (a, b) {
		return {ctor: 'Play', _0: a, _1: b};
	});
var _fifth_postulate$coin_game$Game_Update$ToManyCoins = {ctor: 'ToManyCoins'};
var _fifth_postulate$coin_game$Game_Update$NonPositiveCoins = {ctor: 'NonPositiveCoins'};
var _fifth_postulate$coin_game$Game_Update$NonExistingRow = {ctor: 'NonExistingRow'};
var _fifth_postulate$coin_game$Game_Update$update = F2(
	function (action, model) {
		...
		if (_elm_lang$core$Native_Utils.cmp(_p4, 0) < 1) {
			...
			if (_p1.ctor === 'Nothing') {
				...
				var _p3 = _p1._0;
				if (_elm_lang$core$Native_Utils.cmp(_p4, _p3) > 0) {
					return _elm_lang$core$Result$Err(_fifth_postulate$coin_game$Game_Update$ToManyCoins);
				} else {
...
var _fifth_postulate$coin_game$Game_View$viewCoin = F2(
	function (play, amount) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('coin'),
				_1: {
					ctor: '::',
	...
	function (row, coinsInRow) {
		...
		var htmlCoins = A2(
			...
			_fifth_postulate$coin_game$Game_View$viewCoin(
				_fifth_postulate$coin_game$Game_Update$Play(row)),
			coins);
		return A2(
			_elm_lang$html$Html$div,
			{
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _fifth_postulate$coin_game$Main$main !== 'undefined') {
    _fifth_postulate$coin_game$Main$main(Elm['Main'], 'Main', undefined);
}
